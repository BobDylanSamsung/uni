...
int main(int argc, char ** argv) {
    ...
    char orders[][BUF_SZ] = {
        "BUY 0 Future 10 450;",
        "BUY 1 barenakedladies 25 501;",
        "AMEND 0 20 550;",
        "BUY biggie 100 1000;",
        "BUY 2 biggie 100 1000;",
        "SELL 3 COLE 400 25"
    };
    ...
    bool turns[] = {
        ...
        false, // wait for confirmation
        false, // wait for fill
        false, // wait for other trader 2
        true, // ammend order 0
        false, // wait for fill
        true, // send invalid
        false, // wait for response
        true, // send correct order 2
        false, // wait for confirmation
        false, // wait for other trader 3    
        false, // wait for other trader 4 (disconnect)    
        true, // send order 3
        false, // wait for confirmation
        false // wait for fill
    };
